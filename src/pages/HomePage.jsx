      ...
      {!loading && parentsItems.length > 0 && (
        <section className="py-10 sm:py-12 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-5 lg:px-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-blue-600 mb-6 sm:mb-8 text-left">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
              {parentsItems.map((item) => (
                ...
                >
                  <div className="w-1/3 bg-gray-50 flex items-center justify-center p-3 sm:p-4">
                    <img
                      src={item.image}
                      alt={item.title}
